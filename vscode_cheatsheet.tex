...
\node [mybox] (box){%
    \begin{minipage}{0.3\textwidth}
        ...
        \begin{tabular}{ll}
            ...
            Compare Editor: & \\
            \quad \textbf{\textit{Al}$+$C <a2>} & Go to next/previous change \\ \hline
        \end{tabular}
...
\node [mybox] (box){%
    \begin{minipage}{0.3\textwidth}
        ...
        \begin{tabular}{ll}
            ...
            \quad \textbf{\textit{<a2>}} & \quad Go to next/prev. breakpoint \\
...
\node [mybox] (box){%
    \begin{minipage}{0.3\textwidth}
        ...
        \begin{tabular}{ll}
            ...
            \textbf{\textit{Ct}$+$\textit{<a1>}} & Focus on upper/lower search box \\ \hline
...
\node [mybox] (box){%
    \begin{minipage}{0.3\textwidth}
        ...
        \begin{tabular}{ll}
            ...
            \textbf{\textit{<a2>}} & Navigate breadcrumbs \\ \hline
        \end{tabular}
